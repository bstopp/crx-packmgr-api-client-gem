...
- Build date: 2016-12-21T20:33:05.784-06:00
...
```shell
gem install ./crx_packmgr_api_client-1.0.1.gem
```
(for development, run `gem install --dev ./crx_packmgr_api_client-1.0.1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'crx_packmgr_api_client', '~> 1.0.1'
